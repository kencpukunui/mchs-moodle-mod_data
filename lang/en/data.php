...
$string['newentrybody'] = ' An entry has been added to the Maintenenace list with the folllowing details:

Job Number: {$a->jobid}
Name of Requestor: {$a->requestor}
Title of job: {$a->title}
Description: {$a->description}
Logged to: {$a->loggedto} ';
$string['newentrysub'] = 'New entry to the Maintenance List';
...
// Start - Changes by Pukunui - TXE-274165.
$string['taskname'] = 'Archived Completed DB jobs';
// End - Changes by Pukunui - TXE-274165.
